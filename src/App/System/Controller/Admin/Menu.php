...
/**
 * @BeMenuGroup("网站装修", icon="el-icon-magic-stick", ordering="2")
 * @BePermissionGroup("网站装修", ordering="2")
 */
class Menu extends Auth
{

    /**
     * @BeMenu("菜单导航", icon="el-icon-position", ordering="2.1")
     * @BePermission("菜单导航", ordering="2.1")
     */
     ...
     * 菜单项
     *
     * @BePermission("菜单项", ordering="2.11")
     */
