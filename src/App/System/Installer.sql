...
CREATE TABLE `system_task` (
  ...
  `last_execute_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '最后执行时间',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `app` (`app`)
...
CREATE TABLE `system_admin_user` (
  ...
  `this_login_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '本次登陆时间',
