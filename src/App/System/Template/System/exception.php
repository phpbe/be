<be-head>
    ...
    if ($configSystem->developer) {
        ...
        ?>
        <link rel="stylesheet" href="<?php echo $appSystemWwwUrl; ?>/system/css/be-tab.css" type="text/css"/>
        <script type="text/javascript" src="<?php echo $appSystemWwwUrl; ?>/system/js/be-tab.js"></script>

        <link rel="stylesheet" href="<?php echo $appSystemWwwUrl; ?>/lib/google-code-prettify/prettify.css" type="text/css"/>
        <script type="text/javascript" src="<?php echo $appSystemWwwUrl; ?>/lib/google-code-prettify/prettify.js"></script>
        <style type="text/css">
            pre.prettyprint {
