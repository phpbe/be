    ...
    <div id="app" v-cloak>
            ...
            <div class="storage-toolbar">
                <div class="be-row">
                    <div class="be-col-auto">
                        ...
                        <el-button type="default" size="medium" icon="el-icon-upload2" v-if="files.length < 900" @click="uploadFile()">上传<?php echo $filterName; ?></el-button>
                    </div>
        ...
        <el-dialog v-loading="uploadFileLoading" :visible.sync="uploadFileVisible" title="批量上传<?php echo $filterName; ?>" :center="true" :close-on-click-modal="false" :close-on-press-escape="false">
            ...
            if ($this->filterImage === 1) {
                ?>
                <div class="storage-upload-image">
                    <el-upload
                            ref="uploadFileRef"
                            v-loading="uploadFileUploading"
                            element-loading-text="上传中..."
                            action="<?php echo beAdminUrl('System.Storage.uploadImage'); ?>"
        ...
        let vueCenter = new Vue({
            ...
            methods: {
                loadData: function () {
                    this.loading = true;
                    var _this = this;
                    this.$http.post("<?php echo beAdminUrl('System.Storage.pop', ['filterImage' => $this->filterImage]); ?>", {
                ...
                renameFileSave: function () {
                    ...
                    var _this = this;
                    this.$http.post("<?php echo beAdminUrl('System.Storage.renameFile', ['filterImage' => $this->filterImage]); ?>", {
