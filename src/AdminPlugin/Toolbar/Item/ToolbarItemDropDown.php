 ...
 * 工具栏 下拉菜单
 */
class ToolbarItemDropDown extends ToolbarItem
{
    ...
    public function __construct(array $params = [])
    {
        ...
        if (!isset($this->ui['dropdown']['@command'])) {
            $this->ui['dropdown']['@command'] = 'toolbarItemDropDownClick';
        }
        ...
        if (isset($params['menus'])) {
            ...
            if (is_array($tmpMenus)) {
                ...
                foreach ($tmpMenus as $tmpMenu) {
                    ...
                    $tmpMenu['index'] = $i++;
                    $newMenus[] = new ToolbarItemDropDownMenu($tmpMenu);
                }
                $this->menus = $newMenus;
            }
        }
    ...
    {
        return [
            'toolbarItemDropDownClick' => 'function (command) {
            ...
            'toolbarItemDropDownMenuCommand' => 'function (name, index) {
