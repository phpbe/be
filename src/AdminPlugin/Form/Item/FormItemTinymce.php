...
class FormItemTinymce extends FormItem
{
    ...
    public function __construct($params = [], $row = [])
    {
        ...
        $this->option = [
            ...
            'images_upload_url' => beAdminUrl('System.AdminPlugin.formItemTinymce')
        ];
        ...
        switch ($layout) {
            ...
            case 'simple':
                $this->option = array_merge($this->option, [
                    'plugins' => 'advlist autosave code fullscreen image imagetools link lists media table',
                    'toolbar' => 'formatselect bold italic strikethrough underline forecolor backcolor align removeformat | bullist numlist outdent indent | link image media table | code fullscreen',
                    'menubar' => false,
                    'statusbar' => false,
                ]);
                break;
            case 'full':
                $this->option = array_merge($this->option, [
                    'plugins' => 'advlist anchor autolink autosave charmap charmap code codesample directionality emoticons fullscreen help hr image imagetools importcss insertdatetime link lists media nonbreaking noneditable pagebreak paste preview print quickbars save searchreplace table template textpattern toc visualblocks visualchars wordcount',
                    'toolbar' => 'undo redo | fontselect fontsizeselect formatselect bold italic underline strikethrough forecolor backcolor alignleft aligncenter alignright alignjustify removeformat | bullist numlist outdent indent | link image media table codesample anchor pagebreak charmap emoticons template | code preview fullscreen',
